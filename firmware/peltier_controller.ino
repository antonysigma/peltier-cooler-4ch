...
PID_control peltierA (&sensors, tempSenseChA, peltierPinA, lockLED, fanPinA, PID_sampleMillis, Kp, Ti, Td);
PID_control peltierB (&sensors, tempSenseChB, peltierPinB, lockLED, fanPinB, PID_sampleMillis, Kp, Ti, Td);
...
loop ()
{
    ...
    displayTemp (currentTime, peltierA.getSystemoutput(), peltierA.getSysteminput(),
